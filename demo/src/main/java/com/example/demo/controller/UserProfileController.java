...
public class UserProfileController {
	...
	@PutMapping("/user/{id}")
	public void putUserprofile(@RequestParam("id") String id, @RequestParam("name") String name,
	...
	@PostMapping("/user/{id}")
	public void postUserProfile(@RequestParam("id") String id, @RequestParam("name") String name,
			@RequestParam("phone") String phone, @RequestParam("address") String address) {
